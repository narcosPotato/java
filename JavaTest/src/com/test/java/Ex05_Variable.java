...
public class Ex05_Variable {
	...
	public static void main(String[] args) {
		...
		//운영 체제
		//- 8bit 운영 체제  > int > 1byte
		//- 16bit 운영 체제 > int > 2byte
		//- 32bit 운영 체제 > int > 4byte
		//- 64bit 운영 체제 > int > 8byte(X) > 4byte(O)
		...
		System.out.println(f1); //123456790000000000000000000000
		System.out.println(d1); //123456789012345680000000000000
		...
		int n = 1; // 숫자 1 = 0000 0000 0000 0000 0000 0000 0000 0001
